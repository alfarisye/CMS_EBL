                                                    ...
                                                    <?php foreach ($contractor_distance as $name => $val) : ?> {
                                                            ...
                                                            data: [
                                                                <?php foreach ($val as $v) : ?> {
                                                                        ...
                                                                        y: "<?= handleDivision(handleDivision($v['ob'] ?? 0, $v['ob_total'] ?? 0), $v['target_ob']) * 100 ?>",
                                                                    },
                                                                <?php endforeach; ?>
                                                            ]
                                                        },
                                                ...
                                                series: [
                                                    <?php foreach ($contractor_distance as $name => $val) : ?> {
                                                            ...
                                                            data: [
                                                                <?php foreach ($val as $v) : ?> {
                                                                        x: "<?= $bulan[$v['bulan']] ?? ($time == 'daily' ? date("d-m-Y", strtotime($v['bulan'])) : $v['bulan']) ?>",
                                                                        y: "<?= handleDivision(handleDivision($v['cg'] ?? 0, $v['cg_total'] ?? 0), $v['target_cg']) * 100 ?>",
                                                                    },
                                                                <?php endforeach; ?>
                                                            ]
                                                        },
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body" style="height: 600px">
                        ...
                        <!-- Pie Chart -->
                        <div id="pieChart" style="margin-top: 20%;"></div>
