...
<body>
    ...
    <div id="monitor">
        ...
        <!-- lorem ipsum -->
        <div v-if="datanya" class="px-4 pt-2 mt-4">
            ...
            <div class="row" style="margin-top:-30px;position:relative;">
                <div class="col-sm-3 " style="background:#1C315E;">
                    <p class="text-center text-2xl  font-semibold text-white">{{jam}}</p>
                </div>
                <div class="col-sm-9" style="background:#227c70;">
                    <p class="text-center text-2xl  font-semibold text-white">COAL MONITORING SYSTEM PT ENERGI BATUBARA LESTARI</p>
                </div>
            </div>
        </div>
        <div v-else>
