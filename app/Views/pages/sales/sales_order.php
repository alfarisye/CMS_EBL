        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="<?= site_url("sales/sales-order") ?>">Sales Order</a></li>
                </ol>
            </nav>
        </div>
            ...
            <div class="rounded-lg shadow p-3 bg-white animate__animated animate__bounceIn" style="height:80vh;overflow:scroll;">
               ...
               <form action="" @submit.prevent='showInsert?insertData():updateData()'>
                <table class="table table-sm ">
                    <tr>
                        <td class="p-2">Sales Order No</td>
                        <td class="px-2">:</td>
                        <td>
                            <input required disabled type="text" id="id" name="id"  class="form-control p-1  rounded-sm shadow-sm" placeholder="Sales Order ID..." v-model="vdata['id']" >
                        </td>
                    </tr>
                    <!-- <tr>
                        <td class="p-2">Contract Order</td>
                        <td class="px-2">:</td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td class="px-2">:</td>
                        <td>
                            <select class='form-control' v-model="vdata.type">
                                <option>Local</option>
                    ...
                    <tr>
                        ...
                        <td class="px-2">:</td>
                        <td>
                            <select class='form-control' v-model="vdata.category">
                                <option v-if="vdata.type=='Export' || vdata.type=='Local'">FOBB</option>
                                <option v-if="vdata.type=='Export' || vdata.type=='Local'">CIF</option>
                                <option v-if="vdata.type=='Local'">Franco Pabrik</option>
                                <option v-if="vdata.type=='Export'">MV</option>
                                <option v-if="vdata.type=='Export' ">FAS</option>
                            </select>
                    ...
                    <tr>
                        ...
                        <td class="px-2">:</td>
                        <td>
                            <v-select :options="customer" @input="getBuyerName" label="item_data" v-model="vdata.customer_code" :reduce="e => e.KUNNR"></v-select>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="height:100px;">
                            <textarea type="text" id="address" name="address" rows="2" placeholder="address..." class="form-control md-textarea" v-model="vdata.address"
                            ></textarea>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="px-2">:</td>
                        <td>
                            <v-select :options="product" @input="getProductName" label="item_data" v-model="vdata.product" :reduce="e => e.MATNR"></v-select>
                    ...
                    <tr>
                        ...
                        <td class="px-2">:</td>
                        <td>
                            <input required  type="text" id="quantity" name="quantity"  class="form-control p-1  rounded-sm shadow-sm" placeholder="quantity ..." v-model="vdata['quantity']" >
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="px-2">:</td>
                        <td>
                            <input disabled required  type="text" id="uom" name="uom"  class="form-control p-1  rounded-sm shadow-sm" placeholder="uom ..." v-model="vdata['uom']" >
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="px-2">:</td>
                        <td>
                            <input required  type="text" id="contract_price" name="contract_price"  class="form-control p-1  rounded-sm shadow-sm" placeholder="contract_price ..." v-model="vdata['contract_price']" >
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="px-2">:</td>
                        <td>
                            <select class='form-control' v-model="vdata.currency">
                                <option>IDR</option>
                                <option>USD</option>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="px-2">:</td>
                        <td style="height:100px;">
                            <textarea type="text" id="delivery_condition" name="delivery_condition" rows="2" placeholder="delivery_condition..." class="form-control md-textarea" v-model="vdata.delivery_condition"></textarea>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="px-2">:</td>
                        <td style="height:100px;">
                            <textarea type="text" id="price_condition" name="price_condition" rows="2" placeholder="price_condition..." class="form-control md-textarea" v-model="vdata.price_condition"></textarea>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="px-2">:</td>
                        <td style="height:100px;">
                            <textarea type="text" id="quality_parameter" name="quality_parameter" rows="2" placeholder="quality_parameter..." class="form-control md-textarea" v-model="vdata.quality_parameter"></textarea>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="px-2">:</td>
                        <td style="height:100px;">
                            <textarea type="text" id="parameter" name="parameter" rows="2" placeholder="parameter..." class="form-control md-textarea" v-model="vdata.parameter"></textarea>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="px-2">:</td>
                        <td style="height:100px;">
                            <textarea type="text" id="top" name="top" rows="2" placeholder="top..." class="form-control md-textarea" v-model="vdata.top"></textarea>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="p-2">Valid Until</td>
                        <td class="px-2">:</td>
                        <td>
                            <input  type="date" id="valid_until" name="valid_until"  class="form-control p-1  rounded-sm shadow-sm" placeholder="valid_until ..." v-model="vdata['valid_until']" >
                        </td>
                    </tr>
                    <tr>
    ...
    new Vue({
        ...
        methods: {
            ...
            async mintaApproval(item){
                ...
                if(cek.data){
                    ...
                    if(confirm('Request Approve ?')){
                        ...
                        this.sendNotification(user.user_name,user.user_name,`Approval Contract ${item.id}`,txt);
                        // let res = await this.sendEmail(user.email,'taufikakbarmalikitkj@gmail.com',`Approval Contract ${item.id}`,txt,item.pdf);
                        this.vdata=item;
                        this.vdata.status='4';
            ...
            getBuyerName(){
                ...
                this.vdata.address=this.customer.filter(e=>e.KUNNR==this.vdata.customer_code)[0].ORT02;
                this.$forceUpdate();
            },
            getProductName(){
            ...
            getProductUom(){
                this.vdata.uom=this.product.filter(e=>e.MATNR==this.vdata.product)[0].MEINS;
                this.$forceUpdate();
            },
            ...
            async insertData(){
                ...
                axios.post("<?= site_url() ?>" + `/api/sales-order`,this.vdata).then(async (res)=>{
                    ...
                    //     qry+=`&${e}=${res.data[e]}`;
                    // })
                    // axios.post("<?= site_url() ?>" + `/api/sales-order/pdf?id=${res.data.id}&contract_no=${res.data.id}${qry}`).then(res=>{
                    //     that.vdata={}
                    // });
                    this.getData();
                }).catch(err=>{
            ...
            async updateData(upload=true){
                ...
                axios.put("<?= site_url() ?>" + `/api/sales-order/${id}`,this.vdata).then(res=>{
                    ...
                    this.modals=false;
                    this.getData()
                    // let keys=Object.keys(that.vdata);
                    // let qry=``;
                    // keys.forEach(e=>{
                    //     qry+=`&${e}=${that.vdata[e]}`;
                    // })
                    // axios.post("<?= site_url() ?>" + `/api/sales-order/pdf?id=${id}&contract_no=${that.vdata.id}${qry}`).then(res=>{
                    // });
            ...
            async getData(){
                ...
                this.product=this.product.filter(e=>e.MATNR=='MN0210000110G19400')
