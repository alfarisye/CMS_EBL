...
<div class="pagetitle">
        <h1>K3LH - Kualitas Air - Parameter</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?= site_url("/") ?>">Home</a></li>
                <li class="breadcrumb-item">Master Data</li>
                <li class="breadcrumb-item active"><a href="<?= site_url("#") ?>">Tambah Parameter</a></li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <!-- button with modal -->                   
                            <div class="right-section">
                                ...
                                <a href="<?= site_url("/tambah-bml") ?>">
                                <button type="button" class="btn btn-primary mb-2">
                                    <i class="bi bi-plus me-1"></i> Tambah Data BML
                                </button>
                                </a>
                            </div>
                            
                        <div class="modal fade" id="verticalycentered" tabindex="-1">
                            <form action="<?= site_url("/tambah-parameter/add") ?>" method="POST" novalidate enctype="multipart/form-data" class="needs-validation" novalidate>
                                <?= csrf_field() ?>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="col-md-12 mt-3">
                                                ...
                                                <div class="col-sm-12">
                                                    <input name="nama_parameter" id="nama_parameter" class="form-control" aria-label="Default select example" required></input>
                                                </div>
                                            </div>
                                            <div class="col-md-12 mt-3">
                                            ...
                                            <div class="col-md-12 mt-3">
                                                <la bel class="form-label">Status</label>
                                                <div class="col-sm-12">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered datatable">
                                ...
                                <tbody>
                                    <?php foreach ($air_para as $para) : ?>
                                        <tr>
                                            <td><?= $para['id_Parameter'] ?></td>
                                            <td><?= $para['nama_parameter'] ?></td>
                                            <td><?= $para['status'] ?></td>
                                            <td class="col">                                          
                                                <a href="<?= site_url('/tambah-parameter/edit/') . urlencode($para['id_Parameter']) ?>" class="btn btn-primary btn-sm col">
                                                    <i class="bi bi-pencil"></i>
                                                </a>
                                                <a onclick="return confirm('Are you sure?')" href="<?= site_url('tambah-parameter/delete/') ?><?= $para['id_Parameter'] ?>" class="btn btn-danger btn-sm col">
