                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mb-4">
                            <div class="d-flex left-section col-5">
                                ...
                                <script>
                                    function getData() {
                                        ...
                                        if (bulan != '' && tahun != '') {
                                            window.location.href = "<?= site_url() ?>" + `/Jamkerja?bulan=${bulan}&tahun=${tahun}`;
                                        }
                                    }
                                </script>
                            ...
                            <div class="right-section">
                                ...
                                <button type="button" class="btn btn-primary mb-2">
                                    <i class="bi bi-plus me-1"></i> Tenaga Kerja
                                </button>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="modal fade" id="verticalycentered" tabindex="-1">
                            <form action="<?= site_url("Jamkerja/add") ?>" method="POST" class="needs-validation" novalidate>
                                <?= csrf_field() ?>
                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">New Jam Kerja</h5>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered datatable">
                                ...
                                <tbody>
                                    <?php foreach ($jam_kerja as $kerja) : ?>
                                        <tr>
                                            ...
                                            <?php foreach ($man_form as $form) : ?>
                                                <td>
                                                    <?php foreach ($from_kerja as $work) : ?>
                                                        <?php if($form['id_form']==$work['id_form'] && $work['id_JamKerja']==$kerja['id_JamKerja']) { ?>
                                                            <?= $work['value'] ?>
                                                        <?php } ?>
                                                    <?php endforeach;?> 
                                                </td>
                                            <?php endforeach;?>
                                            <td class="col">
                                                <a href="<?= site_url('Jamkerja/edit/') . urlencode($kerja['id_JamKerja']) ?>" class="btn btn-primary btn-sm col">
                                                    <i class="bi bi-pencil"></i>
                                                </a>
                                                <a onclick="return confirm('Are you sure?')" href="<?= site_url('Jamkerja/delete/') ?><?= $kerja['id_JamKerja'] ?>" class="btn btn-danger btn-sm col">
