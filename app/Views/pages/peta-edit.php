...
<main id="main" class="main">
    <div id="petaebl" class="d-none">
        ...
        <div class="pagetitle">
            <h1>EDIT PETA - Geo JSON</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?= site_url("/") ?>">Home</a></li>
                    <li class="breadcrumb-item"><a href="<?= site_url("/peta") ?>">Peta</a></li>
                    <li class="breadcrumb-item active"><a href="<?= site_url("/peta/edit") ?>">Peta Edit</a></li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div v-if="modal" style="position: fixed;top: 50%;left: 50%;transform: translateX(-50%) translateY(-50%);z-index:10000005;" class="animate__animated animate__fadeIn">
                                <div style="width:60vw;" class="p-2 bg-white shadow rounded-lg">
                                    MODAL <br>
                                    {{pilih}}
                                </div>
                            </div>
                            ...
                            <div class="pr-2">
                                <div class="row justify-content-center">
                                    <div class="col-md-11 p-3">
                                        <div class="p-2 shadow rounded-lg bg-white">
                                            <p class="font-semibold text-lg text-center">
                                                <span class="typcn typcn-chart-area"></span> Bukaan Lahan
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div v-if="ready">
                                    <!-- MAP -->
                                    <div class="row justify-content-center">
                                        <div class="order-2 sm:order-1 shadow rounded-lg p-3 col-11 position-relative">
                                            <div class="row">
                                                <div class="col-sm-10">
                                                    <div class="row">
                                                        <div class="col-6">
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <div class="sm-form ">
                                                        <input type="text" id="search" name="search" class="form-control p-1 text-xs rounded-lg shadow" placeholder="search" v-model="search">
                                                    </div>
                                                    <div v-for="(item, index) in td" :key="index+'listGeojson'" class="my-2 shadow p-1 py-2 rounded-lg">
                                                        <button type="button" @click="getLayer(item,index)" :class="showLayers[index]?'btn-dark':'btn-dark-outline'" class="btn btn-sm text-xs float-right p-1 ml-2"><span class="typcn typcn-eye-outline text-xs"></span></button>
                                                        <span class="text-xs">
                                ...
                                <div v-else>
                                    <div style="height:80vh;" class="d-flex justify-content-center align-items-center shadow-lg rounded-lg">
                                        <div style="width:100%">
    ...
    new Vue({
        ...
        methods: {
            async getListGeojson(){
                let res=await axios.get('./api/get.php');
