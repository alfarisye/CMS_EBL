<main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1>User Release PR</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?= site_url("/") ?>">Home</a></li>
                <li class="breadcrumb-item">Admin</li>
                <li class="breadcrumb-item active">Release PR</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row" id="app">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">User Release PR</h5>
                        <!-- notification -->
                        ...
                        <button type="button" class="btn btn-primary mb-3" @click="modal1=true">
                            <i class="bi bi-plus me-1"></i> Add new User Release PR
                        </button>
                        <!-- MODAL -->
                        ...
                        <div v-if="modal1" style="position: fixed;top: 50%;left: 50%;transform: translateX(-50%) translateY(-50%);z-index:10005;min-width:70vw;">
                            <div class="rounded-lg shadow p-4 bg-white animate__animated animate__bounceIn">
                                ...
                                <hr>
                                <form action="<?= site_url("/admin/user-release-pr/update") ?>" method="POST" class="needs-validation" novalidate>
                                    <?= csrf_field() ?>
                                    <div class="row">
                                        <div class="col-8">
                                            <p>Nama</p>
                            ...
                            <div class="table-responsive">
                                <table class="table tabl-sm table-bordered">
                                    <tr>
                                        <th>Nama</th>
                                        <th>Jabatan</th>
                                        <th>Release Code PR</th>
                                        <th>Action</th>
                                    </tr>
                                    <tr v-for="(item, index) in filtered">
                                        <td>{{item.fullname}}</td>
                                        <td>{{item.description}}</td>
                                        <td>{{item.relcode_pr}}</td>
                                        <td>
    ...
    <script>
        ...
        methods: {
            pilih(id){
                this.vdata.release_code=this.list_users.filter(e=>e.id==id)[0].relcode_pr.split(',')
