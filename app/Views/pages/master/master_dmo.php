...
<main id="main" class="main">
    <div id="masterDMO" class="d-none">
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="<?= site_url("master/master-dmo") ?>">Master DMO</a></li>
                </ol>
            </nav>
        </div>
               ...
               <form action="" @submit.prevent='showInsert?insertData():updateData()'>
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="sm-form">
                            <textarea type="text" id="dmo" name="dmo" rows="2" placeholder="dmo..." class="form-control md-textarea" v-model="vdata.dmo" ></textarea>
                            </div>
                        </td>
                    </tr>
                </table>
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title" >Master DMO</h5>
                <div class="row py-2" >
                    <div class="col-sm-3">
    ...
    new Vue({
        ...
        data(){
            return{
                ...
                target:{},
                disableInput:[],
                sortTable:['id','sequence','description','status'], // disusun berdasarkan urutan td td td
                modals:false,
                showInsert:false,
                // CUSTOM
                datanya:[],
        ...
        methods: {
            ...
            async insertData(){
                ...
                axios.post("<?= site_url() ?>" + `/api/master-dmo`,this.vdata).then(res=>{
                    sdb.loadingOff();
                    this.modals=false;
            ...
            async updateData(){
                ...
                axios.put("<?= site_url() ?>" + `/api/master-dmo/${id}`,this.vdata).then(res=>{
                    sdb.loadingOff();
                    this.modals=false;
                    this.getData()
            ...
            async deleteData(data){
                ...
                sdb.loadingOn();
                axios.delete("<?= site_url() ?>" + `/api/master-dmo/${data.id}`).then(res=>{
                    sdb.loadingOff();
                    this.modals=false;
            ...
            async getData(){
                let data;
                this.datanya=[]
                data = await axios.get("<?= site_url() ?>" + `/api/get/master-dmo`);
        ...
        mounted() {
            this.getData();
            document.getElementById('masterDMO').classList.remove('d-none');
