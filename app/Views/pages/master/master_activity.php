...
<main id="main" class="main">
    <div id="masterActivity" class="d-none">
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="<?= site_url("sales/master-activity") ?>">Master Activity</a></li>
                </ol>
            </nav>
        </div>
    ...
    new Vue({
        ...
        methods: {
            ...
            async insertData(){
                ...
                axios.post("<?= site_url() ?>" + `/api/master-activity`,this.vdata).then(res=>{
                    sdb.loadingOff();
                    this.modals=false;
            ...
            async updateData(){
                ...
                axios.put("<?= site_url() ?>" + `/api/master-activity/${id}`,this.vdata).then(res=>{
                    sdb.loadingOff();
                    this.modals=false;
                    this.getData()
            ...
            async deleteData(data){
                ...
                sdb.loadingOn();
                axios.delete("<?= site_url() ?>" + `/api/master-activity/${data.id}`).then(res=>{
                    sdb.loadingOff();
                    this.modals=false;
            ...
            async getData(){
                let data;
                this.datanya=[]
                data = await axios.get("<?= site_url() ?>" + `/api/get/master-activity`);
        ...
        mounted() {
            this.getData();
            document.getElementById('masterActivity').classList.remove('d-none');
