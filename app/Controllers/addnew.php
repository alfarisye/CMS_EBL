...
class addnew extends BaseController
{
    public function index()
    {
        ...
        echo view('pages/new-category', $data);
    }
    ...
    public function add()
    {
        ...
        return redirect()->to("/addnew")->with('message', $message);
    }
    ...
    public function delete($id)
    {
        ...
        $Category->delete();
        return redirect()->to("/addnew")->with('message', 'category has been deleted');
    }
    ...
    public function update()
    {
        ...
        return redirect()->to("/addnew")->with('message', 'Category has been updated');
    }
}
