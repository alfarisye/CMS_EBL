    ...
    public function index()
    {
        ...
        if ($type == 'yearly') { //filter by yearly
            ...
            (SELECT IF(YEAR(NOW()) = qmaster.bulan,
				SUM(CASE WHEN budget.month < MONTH(NOW()) THEN budget.ob_monthlybudget_qt ELSE 0 END) 
				+ SUM(CASE WHEN budget.month = MONTH(NOW()) THEN budget.ob_dailybudget_qt * DAY(NOW()) ELSE 0 END),
