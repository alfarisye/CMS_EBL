...
class FiSalesInv extends Model
{
    ...
    // protected $allowedFields    = ["SHIPMENT_ID","CONTRACT_NO","KUNNR","SHIPMENT_TYPE","BLDAT","BUDAT","UKURS","TCURR","ZFBDT","ZTERM","XBLNR","ATTCH","FNL_PRICE","FNL_QTY","FNL_AMNT","SAL_DISC","PPN","PPN_AMNT","PPH_22","PROJK","PRCTR","AUFNR","SGTXT","DOC_NO","BELNR","STBLG","USNAM","CPUDT","created_by","updated_by","deleted_by","SHIPMENT_ID1","SHIPMENT_ID2","SHIPMENT_ID3","SHIPMENT_ID4","SHIPMENT_ID5","SHIPMENT_ID6","SHIPMENT_ID7","SHIPMENT_ID8","SHIPMENT_ID9","SHIPMENT_ID10"];
